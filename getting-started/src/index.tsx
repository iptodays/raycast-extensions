  ...
  return (
    <List>
      <List.Section title="Basics">
        ...
        <LinkListItem title="Invite your teammates" link="raycast://organizations/chaeco/manage" />
      </List.Section>
      <List.Section title="Next Steps">
        <LinkListItem title="Join the Raycast community" link="https://raycast.com/community" />
        <LinkListItem title="Stay up to date via Twitter" link="https://twitter.com/raycast" />
      </List.Section>
    </List>
  );
}
